<script>
	// Your Svelte logic can go here
</script>

<section class="relative grid h-[calc(100vh-66px)] min-h-[700px] grid-cols-1 overflow-hidden lg:grid-cols-2">
	<div class="animate-driftA pointer-events-none absolute -left-[150px] -top-[200px] z-0 h-[800px] w-[800px] bg-[radial-gradient(circle,rgba(232,164,53,0.07)_0%,transparent_60%)]"></div>

	<div class="relative z-10 flex flex-col justify-center border-r border-[rgba(242,237,231,0.07)] px-8 py-20 md:px-[72px]">

<!--		<div class="animate-fadeUp mb-8 inline-flex items-center gap-2 text-[11px] font-medium uppercase tracking-[2.5px] text-[#66c0f4]">-->
<!--			<span class="animate-pulse h-1.5 w-1.5 rounded-full bg-[#66c0f4]"></span>-->
<!--			Your gaming passport-->
<!--		</div>-->

		<h1 class="animate-fadeUp text-white mb-8 text-clamp font-extrabold leading-[0.92] tracking-tight">
			Keep <i class="not-italic text-[#66c0f4]">track</i> of your games anytime, everywhere.
		</h1>
		...
		<div class="animate-fadeUp flex flex-wrap items-center gap-3.5">
			<button class="rounded-full bg-[#66c0f4] px-[34px] py-3.5 text-sm font-bold text-[#12100f] transition-all duration-150 hover:scale-[1.04] hover:bg-[#83d0fc]">
				Get Started
			</button>
			<button class="rounded-full border border-[rgba(242,237,231,0.13)] bg-transparent px-6 py-3.5 text-sm font-medium text-[rgba(242,237,231,0.45)] transition-colors duration-200 hover:border-[rgba(242,237,231,0.3)] hover:text-white">
				See what's possible
			</button>
		</div>
	</div>
...
<style>
	...
	.animate-driftA { animation: driftA 14s ease-in-out infinite alternate; }
	.animate-driftB { animation: driftB 16s ease-in-out infinite alternate; }
	.animate-slowScroll { animation: slowScroll 50s linear infinite; }
