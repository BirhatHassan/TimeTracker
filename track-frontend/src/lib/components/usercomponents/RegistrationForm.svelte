		...
		<div class="mb-8">
			...
			<div class="relative w-full">
				<input
						...
						bind:value={password}
						placeholder="••••••••" class="w-full rounded-lg border border-[rgba(242,237,231,0.1)] bg-transparent pl-4 pr-12 py-3 text-sm text-white outline-none transition focus:border-[#66c0f4]" />
